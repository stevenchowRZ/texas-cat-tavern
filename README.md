...
横屏手机浏览器德州扑克与酒馆经营游戏，采用猫咪像素酒馆风格，支持单人 AI、同一 Wi‑Fi/手机热点下的好友房，以及从酒馆左侧进入的庄园停车测试场景。游戏不包含现金、充值或兑换功能。

庄园与酒馆共用猫猫币余额。控制服务员走到酒馆最左端，或点击左侧红色霓虹“← 进入庄园”，即可进入一至五级庄园；车库当前开放五辆兰博基尼 Revuelto，可从车位选车窗口分别停放并测试角度与停车收益。
